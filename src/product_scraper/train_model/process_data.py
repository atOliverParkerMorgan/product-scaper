...
def html_to_dataframe(
    ...
    """
    def extract_positive_samples(main_content, root_tree, selectors, augment_data, dropout_threshold):
    ...
    def extract_negative_samples(main_content, selectors, labeled_elements, augment_data, dropout_threshold):
        negative_data = []
    ...
    positive_data, labeled_elements = extract_positive_samples(main_content, root_tree, selectors, augment_data, dropout_threshold)
    negative_data = extract_negative_samples(main_content, selectors, labeled_elements, augment_data, dropout_threshold)
    if positive_data:
