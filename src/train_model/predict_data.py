...
from utils.features import NON_TRAINING_FEATURES, TARGET_FEATURE, calculate_proximity_score
...
def predict_category_selectors(
    ...
    X = html_to_dataframe(html_content, selectors=existing_selectors or {}, augment_data=False)
...
def group_prediction_to_products(
    html_content: str, selectors: Dict[str, List[Dict[str, Any]]], categories: List[str], max_distance_threshold: int = 50
) -> List[Dict[str, Any]]:
    """
    ...
    for cat in valid_categories:
        ...
        for p_idx, product in enumerate(products):
            ...
            for c_idx, candidate in enumerate(candidates):
                ...
                dist_tree, dist_index = calculate_proximity_score(anchor_item["xpath"], candidate["xpath"])
